...
function UniversalNavbar({ 
  ...
  campusName = "(Chennai Campus)" 
    ...
    const shouldShowLeftMenu = () => {
        ...
        // FIX: Only hide left menu on these specific pages
        const hideMenuPaths = [
            '/login',
            '/admin/login',
            '/',           // Homepage
        ...
        // FIX: Show menu on ALL pages except the ones in hideMenuPaths
        return !shouldHide;
    };
    ...
    return (
        <div className="fixed top-0 left-0 w-screen h-14 bg-[linear-gradient(130deg,_rgba(36,85,163,1)_23%,_rgba(52,151,219,1)_52%,_rgba(52,142,219,1)_58%,_rgba(52,131,219,1)_65%,_rgba(40,116,166,1)_74%)]">
            <div className="flex justify-between items-center h-full">
                ...
                <div className="pr-4 flex items-center">
                    {/* Show profile on all pages except login pages */}
